...
function EditUser() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:4000/update/${userId}`, formDataObj, {
                headers: {
                    ...
                    <div className="col-12 col-lg-8 col-xl-6">
                        <div className="card shadow-2-strong card-registration" style={{ borderRadius: "15px" }}>
                            <div className="card-body p-3 p-md-4">
                                ...
                                <h3 className="mb-3 pb-2 pb-md-3 mb-md-4 text-center">Edit Employee</h3>
                                <form onSubmit={handleSubmit} encType="multipart/form-data">
                                    ...
                                    <div className="row">
                                        <div className="col-6 mb-4">
                                            ...
                                            <select name='designation' value={formData.designation} onChange={handleChange} className="form-select form-select-lg" id="designation" required>
                                        ...
                                        <div className="col-6 mb-4">
                                            ...
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" name="course" onChange={handleChange} id="mca" value="MCA" checked={formData.course.includes("MCA")} />
                                                <label className="form-check-label" htmlFor="mca">MCA</label>
                                            </div>
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" name="course" onChange={handleChange} id="bca" value="BCA" checked={formData.course.includes("BCA")} />
                                                <label className="form-check-label" htmlFor="bca">BCA</label>
                                            </div>
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" name="course" onChange={handleChange} id="bsc" value="BSC" checked={formData.course.includes("BSC")} />
                                    ...
                                    <div className="row mb-3">
                                                        <div className="col-12 mb-3">
                                                            ...
                                                            <input type="file" multiple className="form-control " onChange={handleChange}  id="img" name="img" accept="image/*"/>
                                                            {formData.existingImg && <p>Existing Image: {formData.existingImg}</p>}
                                                        </div>
                                                    </div>
                                    <div className="mt-3 pt-2">
                                        <input data-mdb-button-init data-mdb-ripple-init className="btn btn-primary btn-lg" type="submit" value="Update" />
                                    </div>
                                </form>
                            </div>
                        </div>
